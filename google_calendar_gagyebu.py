...
def make_money_summary(calendar_obj_list, start_date, end_date):
    ...
    key1, key2, key3, key4, key5 = '[★★총입출계]'+str(False), '[★고정입출계]'+str(True), '[★변동입출계]'+str(False), '[★저축입출계]'+str(True), '[★투자입출계]'+str(False)
    ...
    calendar_obj_summary_dict[key5] = calendar_day_obj(start_date, end_date, '[★투자입출계]', 0, False)
